...
\begin{enumerate}
  ...
  \item \textbf{Forward Proof -- (Alternate Formulation) (from Hyperproperty PiNi to Knowledge PiNi)}
        ...
        lemma 3.1 with the progress and attacker knowledge definitions---as for any
  ...
  \item \textbf{Backward Proof (from Knowledge PiNi to Hyperproperty PiNi)}
        ...
        \begin{addmargin}[1em]{2em}
          ...
          Since $c \in \kpini_\DD \implies k_\rightarrow(c,m_2,p_2,\DD) = k(c,m_2,p_2
          ...
          From the premise, we know that $\alpha$, $\alpha_1$, and $\alpha_2$ are all
          low-visible (non-silent) events. Additionally, from determinism (NF.1), it
